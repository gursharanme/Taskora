                ...
                <div class="relative">
                  ...
                  >
                    <ul>
                      ...
                      <li
                        class="edit-task flex items-center gap-3 px-3 py-2 border-b border-black/10 text-sm hover:bg-blue-500/10 transition-colors duration-200 ease-in-out cursor-pointer"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
